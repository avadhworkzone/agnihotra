...
//           PrefServices.getDouble('currentLong')).then((value) {
//
...
//
//     print("locationController.longitude.value :- ${sunriseSunsetController.countrySunsetTimeZone.value}");
//     return Scaffold(
//         key: _scaffoldKey,
//         endDrawer: Drawer(
//           width: 250.w,
...
//                                         ? PrefServices.getString('sunrise24Hours') // Display 24-hour format if switch is ON
...
class _SunriseSunetScreenState extends State<SunriseSunetScreen> {
                  ...
                  Obx(() {
                    if (settingScreenController.isCountDown.value) {
                      return CustomText(
                        ...
                        //     ? settingScreenController.formatDuration(
                        //     settingScreenController.difference!.value) : '',
                        fontWeight: FontWeight.w500,
                        fontSize: 20.sp,
                      );
                    } else {
                            ...
                            children: [
                              Padding(
                                ...
                                child: Container(
                                  ...
                                  child: Padding(
                                    padding: EdgeInsets.only(top: 25.h),
                                    child: sunriseSunsetController.isLoad
                                        .value &&
                                        sunriseSunsetController.isCountryLoad
                                            .value
                                        ? const CircularProgressIndicator(
                                      color: ColorUtils.white,
                                    ) : (PrefServices.getDouble('currentLat') ==
                                      ...
                                      fontSize: 20.sp,
                                        ...
                                        .formattedSunriseTime.value.isNotEmpty
                                        ? CustomText(
                                      PrefServices.getString('futureSunrise'),
                                      fontWeight: FontWeight.w500,
                                      fontSize: 20.sp,
                                    ) : sunriseSunsetController
                                        .countrySunriseTimeZone.value.isNotEmpty
                                        ? CustomText(
                                      PrefServices.getString(
                                          'countrySunriseTimeZone'),
                                      fontWeight:
                                ...
                                child: Container(
                                  ...
                                  child: Padding(
                                    ...
                                    child: sunriseSunsetController.isLoad
                                      ...
                                      fontWeight: FontWeight.w500,
                                      fontSize: 20.sp,
                                    ) : sunriseSunsetController.formattedSunsetTime
                                        .value
                                        .isNotEmpty
                                        ? CustomText(
                                      PrefServices.getString(
                                      ...
                                      fontSize: 20.sp,
                                        ...
                                        :CustomText(
                                      settingScreenController.is24Hours.value
                                          ?PrefServices.getString('sunset24Hours'):PrefServices.getString('sunset'),
                                      fontWeight: FontWeight.w500,
                                      fontSize: 20.sp,
                                    ),
                                  ),
                              ...
                              if (PrefServices.getDouble('currentLat') != 0 &&
                                ...
                                Row(
                                  ...
                                  children: [
                                    CustomText(
                                      "(${PrefServices.getDouble('currentLat')
                                          .toStringAsFixed(4)},${PrefServices
                                          .getDouble('currentLong')
                                          .toStringAsFixed(4)})",
                                      textAlign: TextAlign.center,
                                      color: ColorUtils.black,
                                    ),
  ...
  getLocation() async {
    ...
    try {
      ...
      if (result.isNotEmpty) {
        address = '${result[0].name}, ${result[0].locality} ${result[0]
            .administrativeArea}';
      }
    } catch (e) {
      Fluttertoast.showToast(msg: "${e.toString()}");
