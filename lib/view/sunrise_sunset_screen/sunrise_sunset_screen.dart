...
import 'package:sunrise_app/view/enter_manually_location_screen/enter_manually_location_screen.dart';
...
class _SunriseSunetScreenState extends State<SunriseSunetScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      print(
          "Init isBellRinging :- ${settingScreenController.isBellRinging.value}");
                  ...
                  children: [
                    Container(
                      ...
                      child: const LocalAssets(
                        imagePath: AssetUtils.profileIcon,
                        scaleSize: 3.5,
                      ),
                    ),
                    SizedBox(
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        InkWell(
                          onTap: () {
                            SlideTransitionAnimation.leftToRightAnimation(
                                const MantraMenuScreen());
                          },
                          child: Container(
        ...
        child: PrefServices.getStringList("locationList").isNotEmpty
            ...
            : Column(
                ...
                children: [
                  TextButton(
                    onPressed: () {
                      SlideTransitionAnimation.rightToLeftAnimationOff(
                          IntegrateGoogleMap(
                        latitude: locationController.currentLat,
            ...
            children: [
              ...
              InkWell(
                onTap: () {
                  ...
                  settingScreenController.isBellRinging.value = PrefServices.getBool('isBellRinging');
