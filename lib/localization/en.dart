Map<String, String> en = {
  ...
  "stdConveLocationTxt":
      "Enter location below in degrees using standard conventions",
  ...
  "checkDeviceTimeTxt":
      "check your device time with time on the internet.please note that accuracy is dependent on network and third party tools-worldtimeapi.org internet.",
